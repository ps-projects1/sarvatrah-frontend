    ...
    <section className="relative w-full h-screen overflow-hidden flex flex-col">
      ...
      <div className="flex items-center justify-center flex-col flex-1 w-full px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative flex flex-col items-center justify-center max-w-5xl mx-auto mb-12 sm:mb-16">
          ...
          <h1 className="text-5xl sm:text-7xl lg:text-8xl xl:text-9xl font-bold text-white text-center mb-4 sm:mb-6 tracking-tight">
          ...
          <h2 className="text-xl sm:text-3xl lg:text-5xl xl:text-6xl font-light text-white text-center mb-4 sm:mb-6">
          ...
          <p className="text-sm sm:text-base lg:text-xl text-white/90 text-center mb-8 sm:mb-12 max-w-3xl leading-relaxed">
            Discover amazing places at exclusive deals. Your journey to unforgettable experiences starts here.
          </p>
        </div>


        <div className="relative flex flex-col items-center justify-center w-full max-w-4xl mx-auto gap-5 sm:gap-6 mb-8 sm:mb-12">
          ...
          <div className="flex items-center gap-2 sm:gap-3 bg-white/95 backdrop-blur-md rounded-full px-2 py-2 shadow-2xl border border-white/20">
            {categories.map((category) => (
              <button
                ...
                className={`flex items-center gap-2 px-4 sm:px-7 py-2.5 sm:py-3 rounded-full font-semibold text-sm sm:text-base ${
          ...
          <div className="flex items-center w-full max-w-3xl bg-white/95 backdrop-blur-md rounded-full shadow-2xl border border-white/20 overflow-hidden">
            ...
            <button
              ...
              className="m-1 px-5 sm:px-8 py-2.5 sm:py-3.5 bg-linear-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold flex items-center justify-center gap-2 rounded-full whitespace-nowrap shadow-lg"
            >
