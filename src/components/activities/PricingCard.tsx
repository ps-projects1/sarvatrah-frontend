...
import { Calendar, Users, ChevronDown, Plus, Minus, Clock } from "lucide-react";
...
const ImprovedPricingCard = ({ activity }: PricingCardProps) => {
  ...
  const bookingUrl = `/activity-booking/${
    activity._id
  }?date=${selectedDate?.toISOString()}&time=${selectedTime}&adults=${numAdults}&seniors=${numSeniors}&children=${numChildren}`;
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="mb-4">
        <div className="border border-gray-300 rounded-lg p-3 hover:border-gray-400 transition-colors">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col flex-1">
              ...
              <select
                ...
                className="text-sm font-medium text-gray-900 bg-transparent outline-none cursor-pointer mt-1"
              >
